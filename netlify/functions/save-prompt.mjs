...
//
// consistency: 'strong'  →  lo que se guarda queda disponible
// AL INSTANTE para quien lo lea (evita que el motor de fondo
// no encuentre el prompt por leerlo demasiado rápido).
// ════════════════════════════════════════════════════════════
