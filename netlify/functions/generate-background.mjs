...
//
// IMPORTANTE: las background functions NO reciben bien los datos
// largos por POST, así que este motor ya NO recibe el prompt.
// Solo recibe { jobId, index } y LEE el prompt del guardadero
